...
import WFStandardPageTemplate from "./components/PageTemplates/WFStandardPageTemplate";

function Home() {

  return (
    <WFStandardPageTemplate currentPage="Home" pageTitle="Home - wilsonfung.ca">
        <Card className="m-0 md:m-4 mb-2 border-noround md:border-round-md overflow-auto flex-grow-1 max-h-full">
